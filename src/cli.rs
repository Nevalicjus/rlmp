...
pub struct Cli {
    #[arg(help = "Place to fetch weather for")]
    pub place: String,

    #[arg(help = "Starting date", value_parser = selected_date_validator, default_value_t = now().date())]
    pub selected_date: NaiveDate,

    #[arg(help = "Don't show namedays", short = 'n', long = "namedays", default_value_t = false)]
    pub no_namedays: bool,

    #[arg(help = "Don't show tui", short = 't', long = "tui", default_value_t = false)]
    pub no_tui: bool,
}

pub fn selected_date_validator(s: &str) -> anyhow::Result<NaiveDate, String> {
